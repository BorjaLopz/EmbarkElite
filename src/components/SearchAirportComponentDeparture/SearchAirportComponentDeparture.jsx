...
function SearchAirportComponentDeparture({
  onSelectAirport,
  placeholder,
  className = "",
  ...
  const { setDepartureLocation } = useDepartureArrivalContext();
  ...
  const handleSelectAirport = (selectedAirport) => {
    setDepartureLocation(selectedAirport);
...
export default SearchAirportComponentDeparture;
