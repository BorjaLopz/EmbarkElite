...
function SearchAirportComponentArrival({
  onSelectAirport,
  placeholder,
  className = "",
  ...
  const { setArrivalLocation } = useDepartureArrivalContext();
  ...
  const handleSelectAirport = (selectedAirport) => {
    setArrivalLocation(selectedAirport);
...
export default SearchAirportComponentArrival;
